...
namespace SmartRent.ManagerSite
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext<ApplicationUserManager<Manager>>(ApplicationUserManager<Manager>.Create);
            app.CreatePerOwinContext<ApplicationSignInManager<Manager>>(ApplicationSignInManager<Manager>.Create);
            ...
            app.UseCookieAuthentication(new CookieAuthenticationOptions
            {
                ...
                Provider = new CookieAuthenticationProvider
                {
                    ...
                    OnValidateIdentity = SecurityStampValidator.OnValidateIdentity<ApplicationUserManager<Manager>, Manager>(
